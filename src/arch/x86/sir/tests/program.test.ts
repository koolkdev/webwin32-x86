...
import { operand } from "../builder.js";
import { SirProgramBuilder } from "../program.js";

test("SirProgramBuilder appends instructions with one var namespace", () => {
  const builder = new SirProgramBuilder();
