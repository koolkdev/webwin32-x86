...
import type { ConditionCode, FlagProducerName, SirFlagProducerConditionOp, SirFlagSetOp, ValueRef, VarRef } from "./types.js";
...
export function createSirFlagProducerConditionOp(
  dst: VarRef,
  cc: ConditionCode,
